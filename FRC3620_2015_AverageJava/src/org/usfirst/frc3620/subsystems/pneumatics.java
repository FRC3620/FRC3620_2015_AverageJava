...
public class pneumatics extends Subsystem {
    ...
    Solenoid valveBasiloid_1 = RobotMap.pneumaticsvalveBasiloid_1;
    Solenoid valveBasiloid_2 = RobotMap.pneumaticsvalveBasiloid_2;
	...
	{
		if(basiloidIn == true && Robot.liftPID.safeToChangeBasiloid())
		{
			valveBasiloid_1.set(true);
			valveBasiloid_2.set(false);
			basiloidIn = false;
		}
		else if (basiloidIn == false && Robot.liftPID.safeToChangeBasiloid())
		{
		...
		{
			System.out.println("Cannot move basiloid, lift is in the way.");
		}
