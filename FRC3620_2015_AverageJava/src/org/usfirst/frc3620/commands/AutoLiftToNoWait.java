 ...
 *
 */
public class  AutoLiftToNoWait extends Command {

	final double spotTo;
    public AutoLiftToNoWait(double position) {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=REQUIRES
        double d = Robot.preferences.getDouble(PreferencesNames.LIFT_BOTTOM_POSITION, 0.0);
    }
