...
public class OI {
	...
	public OI() {
        ...
        indexToteButton = new JoystickButton(operatorJoystick, 4);
        ...
        bottomWheelsOut = new JoystickButton(driverJoystick, 6);
        bottomWheelsOut.whileHeld(new bottomDumpOut());
        bottomTakeIn = new JoystickButton(driverJoystick, 5);
        ...
        SmartDashboard.putData("IndexToteOneButton", new IndexToteOneButton());

        SmartDashboard.putData("StopAutoIndexCmd", new StopAutoIndexCmd());
