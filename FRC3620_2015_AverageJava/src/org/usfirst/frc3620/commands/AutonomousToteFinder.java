...
public class  AutonomousToteFinder extends Command implements PIDSource, PIDOutput {
 ...
 PIDController pidToteFinder = new PIDController(p,i,d,this,this);
	...
	{
		// TODO Auto-generated method stub
		if (UDPReciever.visionData != null)
		{
			System.out.println ("pid got data: " + UDPReciever.visionData);
			SmartDashboard.putString("Vision Data", UDPReciever.visionData.toString());
			if (UDPReciever.visionData.isSeen())
			{
			...
			{
				SmartDashboard.putString("Target", "no Tote");
				return 0;
			}
		}
		else
		{
			System.out.println ("pid cannot find data");
			SmartDashboard.putString("Vision Data", "none");
